...
<!-- clusterer: 마커로 클러스터링 할 수 있는 클러스터러 라이브러리 -->
<!-- services: 장소 검색과 주소-좌표 변환을 할 수 있는 services 라이브러리 -->
<!-- drawing: 지도 위에 마커가 그래픽스 객체를 쉽게 그릴 수 있게 그리기 모드를 지원하는 drawing 라이브러리 -->
...
<!-- https://apis.map.kakao.com/web/sample/ -->
	...
	<script>
		...
		mapOption = {
			center : new kakao.maps.LatLng(33.450701, 126.570667), // 지도의 중심좌표 (지도 생성에 반드시 필요) (위도,경도)
